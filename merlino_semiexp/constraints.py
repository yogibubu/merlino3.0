...
The solver implementation lives in :mod:`merlino_semiexp.fit`; this module is
the stable import surface for other Merlino packages that need Gaussian-style
...
def parse_gaussian_style_constraints(
    ...
    """Parse Merlino/Gaussian-style primitive, linear, and expression constraints."""
