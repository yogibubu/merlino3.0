...
- `advanced/`: advanced calculation windows and launchers for Gaussian, PROVA,
...
- `fortran/`: Fortran backends and legacy numerical programs. Active PROVA
  source is under `fortran/prova/`.
- `bin/`: runnable binaries used by launchers, such as `prova.x`.
