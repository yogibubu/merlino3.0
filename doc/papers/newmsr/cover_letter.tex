...
reports. Its central contribution is to move coordinate construction and
constraint handling to a fully automatic Cartesian/topology layer.

The approach is validated on glycolaldehyde, glycine I, glycine II,
cyclopentadiene, nitrobenzene, azulene, and norcamphor. These examples span
standard acyclic, simple and coupled functional-constraint, cyclic, planar
aromatic, fused-ring, and bridged cases.
