...
$^{15}$N isotopologues, together with the Gly-Ip zero-point corrections of
Kasalov{\'a} et al.\cite{Kasalova2007Glycine} Four Table~5 structural
relations are imposed directly in Gaussian-style syntax: the O--H distance,
the C--O--H angle, the H--N--H scissor angle, and the NH$_2$ wagging
out-of-plane coordinate. GICForge assigns C$_s$ symmetry, generates 24 final
GICs, and selects 15 $A'$ coordinates. Projection of the four constraints
leaves 11 independent fitted variables. The fit converges in four accepted
steps with no rejections, condition number $4.46\times10^3$, complete
rotational RMS residual 0.0988 MHz, maximum residual 0.3196 MHz, and a
positive optimized-space Hessian. The complete rotational comparison and
primitive structural parameters are reported in the Supporting Information.
