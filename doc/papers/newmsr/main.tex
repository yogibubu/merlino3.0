...
Symmetry handling & User-imposed relations & Workflow-dependent & Automatic point-group detection and symmetry completion \\
...
Derived structural uncertainties & Model-dependent & Limited when quantities are post-fit derivatives & Propagated from the optimized Cartesian structure \\
Diagnostics & Established least-squares diagnostics & Program- and workflow-dependent & Rank, conditioning, robust weights, correlations, and leave-one-out checks \\
\bottomrule
\end{tabular}
\end{table*}
...
acyclic Z-matrix is no longer natural: constrained glycine II, cyclic
