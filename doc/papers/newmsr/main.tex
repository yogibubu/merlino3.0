...
The implementation remains compatible with standard semiexperimental
statistical information, automated starting-geometry generation, fast
vibrational-correction workflows, and reduced-dimensionality treatments of
missing C--H deuteration. Its coordinate model is generated from topology,
constrained through primitive internal coordinates, exposed through a flexible
interface, and reported with uniform propagated uncertainties. The same code
base separates covalent topology from auxiliary reference information, so
model-dependent geometry corrections do not alter rank, ring perception, or
GIC symmetry classification.
