    ...
    (tmp_path / "gauin").write_text(
        "\n".join(
            [
                ...
                "0 1",
                "",
                " Stre0001=[ 0.4472*R(  1,  2)+0.4472*R(  1,  3)+0.4472*R(  2,  4)+0.4472*R(  3,  5)+0.4472*R(  4,  5)]",
                " Stre0002=[ 0.7071*R(  1,  2)-0.7071*R(  1,  3)]",
                " Stre0003=[ 0.4082*R(  1, 10)+0.4082*R(  1, 11)+0.4082*R(  2,  6)+0.4082*R(  3,  7)+0.4082*R(  4,  8)+0.4082*R(  5,  9)]",
                " Stre0004=[ 0.7071*R(  1, 10)-0.7071*R(  1, 11)]",
                " Stre0005=[ 0.7071*R(  1,  3)-0.7071*R(  2,  4)]",
                " Stre0006=[ 0.7071*R(  1, 11)-0.7071*R(  2,  6)]",
                " Stre0007=[ 0.7071*R(  2,  4)-0.7071*R(  3,  5)]",
                " Stre0008=[ 0.7071*R(  2,  6)-0.7071*R(  3,  7)]",
                " Stre0009=[ 0.7071*R(  3,  5)-0.7071*R(  4,  5)]",
                " Stre0010=[ 0.7071*R(  3,  7)-0.7071*R(  4,  8)]",
                " Stre0011=[ 0.7071*R(  4,  8)-0.7071*R(  5,  9)]",
